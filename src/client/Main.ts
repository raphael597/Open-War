...
class Client {
  ...
  async initialize(): Promise<void> {
    ...
    // Display font for the wordmark/version chrome. Overpass (SIL OFL) ships in
    // resources/fonts; swap this out if you brand the game differently.
    ...
    if (versionElements.length === 0) {
      ...
      versionElements.forEach((el) => {
        (el as HTMLElement).style.fontFamily = '"OpenWar", Inter, sans-serif';
